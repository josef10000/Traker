...
import { EnvelopeSimple, PaperPlaneRight, CheckCircle, Warning, Eye, Key, Sparkle } from '@phosphor-icons/react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md overflow-y-auto">
      <motion.div
        ...
        className="w-full max-w-4xl my-8 p-6 rounded-3xl border-2 bg-slate-900 border-white/10 text-white shadow-2xl space-y-6"
      >
        {/* CABEÇALHO */}
