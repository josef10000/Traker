...
export const FinancialPerformanceInsights = ({
  stats,
  monthlyGoal,
  effectivenessGoal,
  workingDays,
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Gráfico de Distribuição Temporal e Colchão Projetado / Stats */}
      <section className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        ...
        {/* Acordos Aguardando e Quebrados */}
      ...
      {/* Eficiência por Turno e Colchão Projetado */}
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        {/* Eficiência dos Turnos */}
        <div className="glass-card p-6 rounded-2xl shadow-xl flex flex-col justify-center lg:col-span-1">
          <h4 className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-6 flex items-center gap-2">
        ...
        {/* Colchão Projetado (MRR) */}
        <div className="glass-card p-6 rounded-3xl border border-white/5 relative overflow-hidden group lg:col-span-2 flex flex-col justify-center">
