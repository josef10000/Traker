      ...
      {activeTab === 'forecast' && (
        <div className="space-y-6">
          <div className={`p-4 rounded-2xl border-2 flex items-center gap-3 ${
            isDark ? 'bg-sky-950/20 border-sky-500/30 text-sky-200' : 'bg-sky-50 border-slate-900 text-sky-950 font-extrabold'
          }`}>
            <Info size={24} className="shrink-0 text-sky-500" />
            <p className="text-xs leading-relaxed">
              <strong>Como Funciona o Forecast de Demanda:</strong> O Produto pode solicitar uma quantidade inicial de PAs (ex: 10 PAs). A Diretoria/Empresa, por decisão estratégica de orçamento ou planejamento, aprova uma capacidade limite (ex: 8 PAs). Mesmo quando 100% dos 8 PAs aprovados estiverem contratados (0 Vagas Abertas), a diferença de -2 PAs reflete a <em>Repressão Estratégica de Demanda</em>.
            </p>
          </div>
