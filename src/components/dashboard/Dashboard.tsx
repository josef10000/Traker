...
export const Dashboard = ({ user, profile, onSettingsClick, showToast }: DashboardProps) => {
  ...
  // Efeito para carregar as presenças diárias dos colaboradores
  useEffect(() => {
  ...
  const handleAddNote = async (collaboratorId: string, collaboratorName: string) => {
    ...
    try {
      ...
      setQuickNotesText(prev => ({
        ...prev,
        [collaboratorId]: ''
      }));

      showToast(`Anotação privada registrada para ${collaboratorName}!`, 'success');
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          {!isPresentMode && (
            <>
              ...
              {profile.role === 'supervisor' && (
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all ${
                    viewMode === 'personal' && dashboardTab === 'financial'
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all ${
                    viewMode === 'team' && dashboardTab === 'financial'
                      ? 'bg-primary text-white shadow-lg' 
                      : 'text-slate-500 hover:text-slate-300'
                  }`}
                >
              ...
              {(profile.role === 'manager' || profile.role === 'supervisor') && viewMode === 'team' && (
                <div className="flex glass-card p-1 rounded-xl shadow-2xl">
                  <button
