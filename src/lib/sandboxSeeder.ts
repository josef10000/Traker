...
export const generateSandboxSeeds = (): SandboxSeeds => {
  ...
  const qaEvaluations: Record<string, QaEvaluation> = {
    ...
    'sandbox-eval-2': {
      ...
      delayProfile: '31 a 60 dias (Preventivo)',
  ...
  const auditLogs: AuditLog[] = [
    {
      ...
      userId: 'sandbox-op-1',
      userEmail: 'carlos.op@traker.com.br',
    ...
    },
    {
      ...
      userEmail: 'mariana.sup@traker.com.br',
    ...
    },
    {
      ...
      userId: 'sandbox-op-2',
      userEmail: 'ana.paula@traker.com.br',
  ...
  operatorNames.forEach((op, i) => {
    ...
    let portfolio = 'Carteira Receptivo';
    let monthlyGoal = 210000;
    
    if (i >= 3 && i <= 4) {
      portfolio = 'Carteira Variável';
      monthlyGoal = 80000;
    } else if (i >= 5 && i <= 7) {
      portfolio = 'Carteira BNPL';
      monthlyGoal = 5000;
    } else if (i >= 8 && i <= 9) {
      portfolio = 'Pula Parcela + Ticket Alto';
      monthlyGoal = 10000;
    } else if (i >= 10 && i <= 12) {
      portfolio = 'Carteira - FPD';
      monthlyGoal = 15000;
    } else if (i >= 13) {
      portfolio = 'Carteira Receptivo';
      monthlyGoal = 270000;
    }
  ...
  const recoverySeeds: Agreement[] = [
    ...
    },
    {
      ...
      status: AgreementStatus.BROKEN,
      origin: AgreementOrigin.WHATSAPP,
      type: AgreementType.QUITACAO,
      category: AgreementCategory.VARIAVEL,
      operatorId: 'sandbox-op-2',
      teamId: 'team-fenix',
      organizationId: orgId,
  ...
  backofficeImports[importId] = {
    ...
    fileName: 'acordos_carga_0707.xlsx',
    totalRows: 10,
    validRows: 8,
