...
- **Stories de Conquista**: Novo sistema para gerar e baixar cards personalizados (Stories) com suas principais conquistas do mês (Total Pago, Meta e Ticket Médio), otimizado para alta compatibilidade em dispositivos móveis.
