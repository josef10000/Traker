...
| **🎯 Recrutamento & Seleção (ATS Integrado)** | Gestão completa de vagas em aberto com taxas de preenchimento, **Funil Kanban de Candidatos**, **Registro de Currículo (Texto e PDF)**, **Agendamento de Entrevistas com Alerta em Tempo Real**, **Decisão de Reprovação com Banco de Talentos** e **Efetivação Automática para a sub-aba de Onboarding**. |
