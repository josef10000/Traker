...
| **🎯 Recrutamento & Seleção (ATS Operacional)** | Cockpit amplo de gestão de vagas vinculadas a **Sites da Operação** (com encerramento/reabertura/exclusão), **Upload Direto e Visualizador de PDF Embutido no Tracker**, agendamento de entrevistas com alertas, banco de talentos e admissão flexível via link de convite oficial da equipe. |
